    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand mb-0 h1" href="index.php?overview"
            ...
            | SRI JINANANDA CHILDREN'S HOME |</a>
             <span style="float:right;font-size:25px;color:#fff;padding-top:30px; padding-left:550px;">
                 <?php echo $user_type ?>: <?php echo $name ?> 
            </span>
...
<a href="index.php?viewUsers"> View Donations </a>
            ...
            <li>
                ...
                <a href="index.php?viewStaff" data-toggle="collapse" data-target="#staff" style="color:#fff;">
            ...
            <a href="index.php?viewAttendance" data-toggle="collapse" data-target="#labors" style="color:#fff;">

            <i class="fa fa-fw fa-id-card"></i> Staff Daily Attendance 
           ...
           <!-- <i class="fa fa-fw fa-caret-down"></i>-->
            ...
            <li>
                ...
                <a href="index.php?viewAdoption" data-toggle="collapse" data-target="#child" style="color:#fff;">
